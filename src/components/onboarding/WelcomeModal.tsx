      ...
      <div className="relative w-full h-full">
        ...
        >
          ...
          <div className="w-full max-w-xl text-center">
              ...
              <div className="border border-border-default bg-bg-secondary rounded-lg p-5 flex flex-col items-center gap-3">
                ...
                <div className="flex gap-2">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="h-7 px-3 text-[11px] font-semibold rounded-sm bg-accent-primary text-black hover:brightness-110 transition-all inline-flex items-center"
                  >
            ...
            <p className="text-[10px] text-text-tertiary mb-6">{t("download.releasesNote")}</p>

            {/* Skip link */}
            <button
              type="button"
              onClick={() => advance(6)}
              className="text-xs text-text-tertiary hover:text-accent-primary transition-colors mb-6"
            >
              {t("download.skip")} →
            </button>
