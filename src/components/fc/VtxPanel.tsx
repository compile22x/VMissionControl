...
/** Standard 5.8 GHz FPV bands — band name → channel frequencies (MHz) */
const VTX_BANDS: Record<string, number[]> = {
...
const BAND_INDEX_TO_LETTER: Record<number, string> = {
  1: "A",
  2: "B",
  3: "E",
  4: "F",
...
const BAND_LETTER_TO_INDEX: Record<string, number> = {
  A: 1,
  B: 2,
  E: 3,
  F: 4,
...
const BAND_NAMES = Object.keys(VTX_BANDS);
...
export function VtxPanel() {
  ...
  } = usePanelParams({ paramNames, panelId: "vtx", autoLoad: true });
